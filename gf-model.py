...
def train_model(X, y, input_dim, model_type='CNN', attention_type=None, epochs=150, batch_size=32, learning_rate=0.0001):
    # 使用 K 折交叉验证
        ...
        for target_column, y in y_dict.items():
            ...
            for model_type in ['CNN', 'ResNet18', 'VGG7', 'SATCN']:
                for attention_type in [None, 'SE', 'ECA', 'CBAM']:
                    ...
                    results.append((dataset_name, target_column, f"{attention_type}_{model_type}", train_metrics, test_metrics))
